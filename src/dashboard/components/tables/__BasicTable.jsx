  ...
  import { useGetPhotosQuery, useGetTodoQuery, useGetTodosQuery } from '../../../store/apis';
  ...
  const rows = [
    createData('00239',<StatusLabel label='Aprobado' color='info'></StatusLabel>, 'Metalurigicas Pacifico ', '30-22.333.444-1', 'Factoring', 'Entidad'),
